...
<?php $page = (get_query_var('paged')) ? get_query_var('paged') : 1;	query_posts('post_type=post&showposts=30&meta_key=phim_loai&meta_value=phimle&paged='.$page.'&order=desc');	while (have_posts()) : the_post();?>	
<div class="thumb-grid__item"><div data-video-id="1238793" class="thumb thumb--video js-thumb">
    ...
    <div class="thumb-overlay">
      <div class="thumb-overlay__left">
                              <div class="thumb__rating">
              <i class="i i--size--s i--color-white"><svg><use xlink:href="#i--thumb-up"/></svg></i>
              0%
          </div>
       </div>
