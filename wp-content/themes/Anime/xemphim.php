...
<div id="comment" class="block"><div class="blocktitle"><div class="title">Bình luận</div><div data-target="#comment .tabs-content" class="tabs"><div data-name="fb-comment" class="tab active">Facebook</div><div data-name="phim3s-comment" class="tab phim3s">PHIMHIHI</div></div></div><div class="blockbody tabs-content"><div class="tab fb-comment"><div class="fb-comments" data-href="<?php the_permalink();?>" data-num-posts="20" data-width="660"></div></div><div class="tab phim3s-comment hide"><div class="comment-form"><div class="avatar"></div><form action="#" method="post"><div><textarea rows="1" cols="10" class="message" maxlength="500" data-minlength="10" style="resize: none; overflow: hidden; word-wrap: break-word; height: 45px;"></textarea></div><div><button class="submit" type="button">Bình luận</button><p class="warn">Bạn còn lại <span class="counter">500</span> ký tự</p></div></form></div><div class="comment-list"></div></div></div></div>
<div class="fb-like-box" data-href="http://www.facebook.com/doctruyencuoi" data-width="660" data-height="258" data-show-faces="true" data-stream="false" data-header="false"></div>
