...
<div class="main">
    <div class="cols-group">
        <div class="col col--size--xs">
			...
			<h2 class="side-cats__title">Categories</h2>
...
<?php 
		...
		$most_viewed = $wpdb->get_results("SELECT DISTINCT $wpdb->posts.*, (meta_value+0) AS views FROM $wpdb->posts LEFT JOIN $wpdb->postmeta ON $wpdb->postmeta.post_id = $wpdb->posts.ID WHERE post_date < '".current_time('mysql')."' AND post_status = 'publish' AND meta_key = 'views' AND post_password = '' ORDER  BY views DESC LIMIT 0,30");
...
<?php if(function_exists('wp_pagenavi')) { wp_pagenavi(); } ?>
            ...
            <div class="section"><div class="heading heading--dark"><h3 class="heading__title">Advertisement</h3></div>
