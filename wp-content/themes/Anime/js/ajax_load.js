				...
				return false;
					...
					jQuery.ajax({
							 ...
							 success:function(html){
								 ...
								 if(html == 2) {
									 Boxy.alert("Cám ơn bạn đã quan tâm và sử dụng Mp3.KinhMon.Biz. Mọi ý kiến đóng góp của bạn sẽ được BQT KinhMon.Biz tiếp nhận và giải quyết trong thời gian sớm nhất.", null, {title: 'Thông báo'});
								 }
								 }
						});
		}
