...
$page = (get_query_var('paged')) ? get_query_var('paged') : 1;
	query_posts('post_type=post&showposts=30&meta_key=phim_nsx&meta_value='.$qg.'&paged='.$page.'&order=desc');
	while (have_posts()) : the_post();?><div class="thumb-grid__item"><div data-video-id="1238793" class="thumb thumb--video js-thumb">
