...
$is_youtube2 = (preg_match("#youtube.com/p/(.*?)#",$url));
	...
	$is_zing = (preg_match("#http://video.zing.vn/video/clip/([^/.]+).([^/.]+).html#s",$url));
        $is_zing1 = (preg_match("#http://mp3.zing.vn/tv/media/([^/.]+).([^/.]+).html#s",$url));
...
elseif ($is_youtube2) $type = 96;
	...
	elseif ($$is_zing || $is_zing2 || $is_zing3 || $idvideo_zing || $is_zing1) $type = 14;
...
if($sv1) $total_server .= '<div class="server"><div class="label">Super VIP:</div> <ul class="episodelist">'.$sv1.'</ul></div>';
...
if($sv4) $total_server .= '<div class="server"><div class="label">Youtube</div> <ul class="episodelist">'.$sv4.'</ul></div>';
...
if($sv11) $total_server .= '<div class="server"><div class="label">Clipvn:</div> <ul class="episodelist">'.$sv11.'</ul></div>';
...
if($sv14) $total_server .= '<div class="server"><div class="label">ZingVideo:</div> <ul class="episodelist">'.$sv14.'</ul></div>';
...
if($sub=="") $sub='http://phim76.net/sub/alophim.srt';
if(!$sv){
	...
	register_post_type('tin-tuc',
		array(
			'labels' => array(
				...
				'add_new_item'  =>  __('Thêm phim mới'),
				'edit'  =>  __('Sửa'),
				'edit_item' =>  __('Sửa Tin tức'),
				'new_item'  =>  __('Tin tức mới'),
				'view'  =>  __('Danh sách Tin tức'),
				'view_item' =>  __('Danh sách Tin tức'),
				'search_items' =>  __('Tìm kiếm Tin tức'),
				'not_found' =>  __('Không tìm thấy Tin tức nào'),
				'not_found_in_trash'  =>  __('Không có Tin tức nào trong thùng rác')
			),
			'public'  =>  true,
	        'show_ui' =>  true,
	        ...
	        'menu_position' => 5,
	        //'menu_icon' =>  get_stylesheet_directory_uri(). '/library/img/movie.png',
	        'hierarchical'  => false,
	        'query_var' =>  true,
	        'supports'  =>  array(
