...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'options' => array('' => 'Tình trạng','phimdecu' => 'Phim bộ chưa hoàn thành','hoanthanh' => 'Phim bộ hoàn thành','tophot'=>'Tiêu Điểm'
			),
		...
		array(
			...
			'type' => 'select',
			// Array of 'value' => 'Label' pairs for select box
			'options' => array('' => 'Tình trạng','Tiêu Điểm' => 'Tiêu Điểm'
			),
			// Select multiple values, optional. Default is false.
		...
		array(
			...
			'type' => 'select',
			// Array of 'value' => 'Label' pairs for select box
			'options' => array('phimle' => 'Phim lẻ','phimbo' => 'Phim Bộ' ,'mvnhac' => 'MV Nhạc'
			),
			// Select multiple values, optional. Default is false.
