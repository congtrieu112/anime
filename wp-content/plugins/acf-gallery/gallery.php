...
class acf_field_gallery extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->l10n = array(
			'select'		=>	__("Add Video to Gallery",'acf'),
			'edit'			=>	__("Edit Video",'acf'),
			'update'		=>	__("Update Video",'acf'),
			'uploadedTo'	=>	__("uploaded to this post",'acf'),
			'count_0'		=>	__("No Video selected",'acf'),
			'count_1'		=>	__("1 video selected",'acf'),
			'count_2'		=>	__("%d ideos selected",'acf'),
		);
...
<div class="acf-gallery" data-preview_size="<?php echo $field['preview_size']; ?>" data-library="<?php echo $field['library']; ?>">
	...
	<div class="thumbnails">
		...
		$video_field = $field['value'];
		$video_array = array();
		//print_r( $video_field );
		
		if( !empty( $video_field ) && !is_array( $video_field ) ){
			$video_array[0] = array( 
				'id'	=>	$video_field,
				'alt'	=>	'',
				'title'	=>	'',
			...
			$video_array	=	 $field['value'];
		}
		if( $video_array ): foreach( $video_array as $attachment ): 
	...
	<div class="toolbar">
		<ul class="hl clearfix">
			<li class="add-image-li"><a class="acf-button add-image" href="#"><?php _e("Add Video",'acf'); ?></a></li>
